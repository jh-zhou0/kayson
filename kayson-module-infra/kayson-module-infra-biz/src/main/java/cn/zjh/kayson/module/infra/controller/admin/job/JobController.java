package cn.zjh.kayson.module.infra.controller.admin.job;
...
import cn.zjh.kayson.module.infra.controller.admin.job.vo.job.*;
import cn.zjh.kayson.module.infra.convert.job.JobConvert;
import cn.zjh.kayson.module.infra.dal.dataobject.job.JobDO;
import cn.zjh.kayson.module.infra.service.job.JobService;
...
public class JobController {
    ...
    public CommonResult<Boolean> updateJob(@Valid @RequestBody JobUpdateReqVO updateReqVO) throws SchedulerException {
    ...
    public void exportJobExcel(@Valid JobExportReqVO exportReqVO, HttpServletResponse response) throws IOException {
        List<JobDO> list = jobService.getJobList(exportReqVO);
        // 导出 Excel
        List<JobExcelVO> data = JobConvert.INSTANCE.convertList02(list);
        ExcelUtils.write(response, "定时任务.xls", "数据", JobExcelVO.class, data);
    }
