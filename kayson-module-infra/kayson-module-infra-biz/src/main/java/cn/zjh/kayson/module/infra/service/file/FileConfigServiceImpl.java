...
import cn.zjh.kayson.module.infra.convert.file.FileConfigConvert;
...
public class FileConfigServiceImpl implements FileConfigService {
    ...
    public void updateFileConfig(FileConfigUpdateReqVO updateReqVO) {
        // 校验存在
        FileConfigDO fileConfig = validateFileConfigExists(updateReqVO.getId());

        FileConfigDO updateObj = FileConfigConvert.INSTANCE.convert(updateReqVO);
        updateObj.setConfig(parseClientConfig(fileConfig.getStorage(), updateReqVO.getConfig()));
        // 更新文件配置
    ...
    public String testFileConfig(Long id) throws Exception {
        ...
        validateFileConfigExists(id);
        // 上传文件
        byte[] content = ResourceUtil.readBytes("file/cat.png");
