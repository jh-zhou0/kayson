...
public class ApiAccessLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiAccessLogPage() {
        ApiAccessLogDO apiAccessLogDO = randomPojo(ApiAccessLogDO.class, o -> {
            ...
            o.setRequestUrl("foo");
            o.setBeginTime(buildTime(2023, 6, 6));
            o.setDuration(1000);
        ...
        apiAccessLogMapper.insert(cloneIgnoreId(apiAccessLogDO, o -> o.setBeginTime(buildTime(2023, 6, 1))));
        // 测试 duration 不匹配
        ...
        reqVO.setBeginTime(buildBetweenTime(2023, 6, 5, 2023, 6, 7));
