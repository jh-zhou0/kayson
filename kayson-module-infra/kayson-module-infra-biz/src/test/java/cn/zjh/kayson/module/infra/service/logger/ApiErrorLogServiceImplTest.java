...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("kayson-test");
            o.setRequestUrl("foo");
            o.setExceptionTime(buildTime(2023, 6, 6));
        ...
        apiErrorLogMapper.insert(cloneIgnoreId(apiErrorLogDO, logDO -> logDO.setExceptionTime(buildTime(2023, 6, 1))));
        ...
        reqVO.setApplicationName("kayson-test");
        reqVO.setRequestUrl("foo");
        reqVO.setExceptionTime(buildBetweenTime(2023, 6, 5, 2023, 6, 7));
