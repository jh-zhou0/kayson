package cn.zjh.kayson.module.system.controller.admin.logger.vo.operatelog;
...
public class OperateLogBaseVO {
    ...
    @Schema(description = "操作模块", requiredMode = Schema.RequiredMode.REQUIRED, example = "管理后台 - 用户")
    @NotEmpty(message = "操作模块不能为空")
    private String module;

    @Schema(description = "操作名", requiredMode = Schema.RequiredMode.REQUIRED, example = "创建用户")
    ...
    @Schema(description = "操作明细", example = "修改编号为 1 的用户信息，将性别从男改成女，将姓名从a改成b。")
    ...
    @Schema(description = "Java 方法名", requiredMode = Schema.RequiredMode.REQUIRED, example = "cn.zjh.kayson.module.system.controller.admin.user.UserController.createUser")
