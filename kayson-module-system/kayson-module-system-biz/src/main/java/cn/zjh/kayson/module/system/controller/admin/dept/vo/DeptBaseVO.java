...
public class DeptBaseVO {
    ...
    @Schema(description = "菜单名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "Kayson")
    ...
    @Schema(description = "联系电话", example = "18988998899")
    @Size(max = 11, message = "联系电话长度不能超过11个字符")
    private String phone;

    @Schema(description = "邮箱", example = "1525090646@qq.com")
