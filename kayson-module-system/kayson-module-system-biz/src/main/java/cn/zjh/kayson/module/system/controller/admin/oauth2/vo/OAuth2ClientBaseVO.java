...
public class OAuth2ClientBaseVO {
    ...
    @Schema(description = "客户端编号", requiredMode = Schema.RequiredMode.REQUIRED, example = "apple")
    ...
    @Schema(description = "应用名", requiredMode = Schema.RequiredMode.REQUIRED, example = "苹果")
    ...
    @Schema(description = "附加信息", example = "{kayson: true}")
