...
import cn.zjh.kayson.module.system.service.logger.OperateLogService;
...
public class OperateLogController {
    ...
    public CommonResult<PageResult<OperateLogRespVO>> pageOperateLog(@Valid OperateLogPageReqVO reqVO) {
        ...
        // 获得拼接需要的数据
        List<Long> userIds = CollectionUtils.convertList(pageResult.getList(), OperateLogDO::getId);
