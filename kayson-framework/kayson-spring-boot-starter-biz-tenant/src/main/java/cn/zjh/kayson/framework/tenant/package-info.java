 ...
 *      1）Spring Async：
 *          {@link cn.zjh.kayson.framework.quartz.config.KaysonAsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 *      2）Spring Security：
 *          TransmittableThreadLocalSecurityContextHolderStrategy
 *          和 KaysonSecurityAutoConfiguration#securityContextHolderMethodInvokingFactoryBean() 方法
 * 
 * @author zjh - kayson
 */
package cn.zjh.kayson.framework.tenant;