package cn.zjh.kayson.framework.dict.core.util;

import cn.hutool.core.util.ObjectUtil;
import cn.zjh.kayson.framework.common.core.KeyValue;
...
public class DictFrameworkUtils {
     ...
     */
    public static final LoadingCache<KeyValue<String, String>, DictDataRespDTO> PARSE_DICT_DATA_CACHE = CacheUtils.buildAsyncReloadingCache(
            Duration.ofMinutes(1L), // 过期时间 1 分钟
            new CacheLoader<KeyValue<String, String>, DictDataRespDTO>() {
                @Override
                public DictDataRespDTO load(KeyValue<String, String> key) {
    ...
    public static String getDictDataLabel(String dictType, String value) {
        return GET_DICT_DATA_CACHE.get(new KeyValue<>(dictType, value)).getValue();
    }
